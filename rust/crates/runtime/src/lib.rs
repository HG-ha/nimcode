//! Core runtime primitives for the `nimcode` CLI and supporting crates.
//!
...
pub use stale_base::{
    check_base_commit, format_stale_base_warning, read_nimcode_base_file, resolve_expected_base,
